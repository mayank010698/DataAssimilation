...
# Evaluation script for Lorenz-96 DBF with observation-consistency RF proposal sweep.
# - Single noiseless dataset (matching the obs-consistency training dataset but without injected process noise).
# - One EnKF baseline run.
# - One EnSF baseline run.
# - One EnSF+RF run per trained obs-consistency proposal (8 total: 1 baseline RF + 7 obs-consistency weights).
...
echo "============================================="
echo "Lorenz96 (40D) DBF Obs-Consistency RF Evaluation"
echo "============================================="

# Common parameters (mirroring prev-corr / gated eval scripts where sensible)
BATCH_SIZE=50
...
WANDB_PROJECT="eval-96-obscons"
DATE_PREFIX=$(date +%Y%m%d)

PYTHON_BIN="/home/cnagda/miniconda3/envs/da/bin/python"

# Single noiseless dataset corresponding to the obs-consistency training dataset
# Training used:
...
# ---------------------------------------------------------------------------
# Obs-consistency RF checkpoints
# Names mirror those in train_96_dbf_rf_obscons_sweep.sh:
#   l96_dbf_rf_obscons_w000
#   l96_dbf_rf_obscons_w1e4
#   l96_dbf_rf_obscons_w3e4
#   l96_dbf_rf_obscons_w1e3
#   l96_dbf_rf_obscons_w3e3
#   l96_dbf_rf_obscons_w1e2
#   l96_dbf_rf_obscons_w3e2
#   l96_dbf_rf_obscons_w1e1
# ---------------------------------------------------------------------------
...
NUM_PROPOSALS=${#OBSCONS_NAMES[@]}

RF_CKPTS=()
LABELS=()
for NAME in "${OBSCONS_NAMES[@]}"; do
...
# 3) EnSF + RF: one per obs-consistency RF proposal
...
echo "============================================="
echo "All obs-consistency RF evaluation jobs completed."
