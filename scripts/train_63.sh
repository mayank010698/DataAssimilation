...
declare -a EXPERIMENTS=(
    ...
    "L63, 0.25 pnoise, all 3 dims obs:$DATA_DIR_NOISE:rf_runs/lorenz63_len1000_obs_all3_pnoise0p250:0,1,2:train_l63_obs_all3_pnoise.log"
    "L63, 0.25 pnoise, only 1st dim obs:$DATA_DIR_NOISE:rf_runs/lorenz63_len1000_obs_dim0_pnoise0p250:0:train_l63_obs_dim0_pnoise.log"
)
